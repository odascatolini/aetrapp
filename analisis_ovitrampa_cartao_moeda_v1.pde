...
int countEggs(int diameterPx, int circleAreaPx, PImage img) {
    ...
    float eggInPx = (0.3157 * circleAreaPx / 615.752) * 2; // number of pixels per egg in the sample - (* 2: tem erro aqui. revisar. além disso, serão necessárias mais amostras para calibrar)
